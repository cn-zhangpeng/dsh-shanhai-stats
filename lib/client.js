...
.cc-sidebar-action { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:2px; min-width:48px; max-width:72px; padding:4px 2px; border-radius:6px; cursor:pointer; font-size:10px; line-height:1.2; color:var(--dsw-alias-label-secondary); transition:background-color .15s ease, color .15s ease; }
...
.cc-sidebar-action-main { display:flex; flex-direction:column; align-items:center; gap:0; min-width:0; }
.cc-sidebar-action-label { font-size:10px; white-space:nowrap; }
.cc-sidebar-action-value { font-size:10px; font-weight:600; color:var(--dsw-alias-label-primary); white-space:nowrap; }
