...
.cc-sidebar-action { display:flex; align-items:center; gap:8px; padding:8px 12px; margin:0 -6px; border-radius:8px; cursor:pointer; font-size:13px; color:var(--dsw-alias-label-secondary); transition:background-color .15s ease, color .15s ease; }
...
.cc-sidebar-action-main { display:flex; align-items:center; gap:8px; min-width:0; }
.cc-sidebar-action-label { font-size:13px; }
.cc-sidebar-action-value { font-size:13px; font-weight:600; color:var(--dsw-alias-label-primary); white-space:nowrap; }
...
`
    ...
    exports.apply = (ctx) => {
      ...
      slots.inject('sidebar.action', () => slots.register(
        { name: 'sidebar.action', id: 'shanhai-stats-today', order: 1 },
