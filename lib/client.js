...
.cc-sidebar-action { display:flex; align-items:center; gap:8px; padding:8px 12px; margin:0 -6px; border-radius:8px; cursor:pointer; font-size:12px; color:var(--dsw-alias-label-secondary); transition:background-color .15s ease, color .15s ease; }
      ...
      return React.createElement(React.Fragment, null,
        React.createElement('div', { className: 'cc-sidebar-action', onClick: () => setOpen(true), title: '查看今日用量' },
          ...
          React.createElement('div', { className: 'cc-sidebar-action-main' },
            ...
            React.createElement('span', { className: 'cc-sidebar-action-value', style: { whiteSpace: 'nowrap' } }, todayStats === null ? '加载中…' : fmtCompact(total)),
          ),
        ),
