...
.cc-sidebar-action { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:1px; padding:4px 2px; border-radius:6px; cursor:pointer; font-size:10px; line-height:1.25; color:var(--dsw-alias-label-secondary); transition:background-color .15s ease, color .15s ease; }
...
.cc-sidebar-action-main { display:flex; flex-direction:column; align-items:center; min-width:0; }
